...
./dev/builddeps-veloxbe.sh --build_type=Debug --build_tests=OFF --build_benchmarks=OFF --enable_s3=ON --enable_gcs=ON --enable_hdfs=ON --enable_abfs=ON --num_threads=72
